<template>
    <b-row>
        <b-col lg="12">
            <b-card class="mx-0 mx-md-3" body-class="p-0">
                <div class="">
                    <ul class="iq-edit-profile row nav nav-pills mb-0">
                        <li class="col-md-3 p-0 text-center">
                            <a class="nav-link active p-4 text-secondary" data-bs-toggle="pill"
                                ...
                                <form>
                                    <div class="form-group row align-items-center">
                                        <div class="col-md-12">
                                            <div class="profile-img-edit1">
                                                <img class="profile-pic1" src="/assets/images/avatars/1.jpg"
                                    ...
                                    <div class=" row align-items-center">
                                        <div class="form-group col-sm-6">
                                            ...
                                            <input type="text" class="form-control" id="fname" placeholder="Barry"
                                                style="height: 45px;">
                                        </div>
                                        <div class="form-group col-sm-6">
                                            <label for="lname" class="form-label">Last Name:</label>
                                            <input type="text" class="form-control" id="lname" placeholder="Tech">
                                        </div>
                                        <div class="form-group col-sm-6">
                                            <label for="uname" class="form-label">User Name:</label>
                                            <input type="text" class="form-control" id="uname" placeholder="Barry@01">
                                        </div>
                                        <div class="form-group col-sm-6">
                                        ...
                                        <div class="form-group col-sm-6">
                                            ...
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="inlineRadioOptions"
                                                    id="inlineRadio10" value="option1" checked>
...
Zip Code: 85001
                                    ...
                                    <b-button type="reset" variant="danger-subtle">Cancel</b-button>
                                </form>
                            </b-card-body>
                        </b-card>
                    </div>
                            ...
                            <div class="card-body">
                                <form>
                                    <div class="form-group">
                                        ...
                                        <router-link to="/auth/recover-pw" class="float-end">Forgot Password</router-link>
