  ...
  <b-row>
                    ...
                    <div class="d-flex align-items-center flex-wrap">
                        <div class="dropdown me-3">
                            ...
                            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton04"
                                style="">
                                <a class="dropdown-item gap-2 d-flex align-items-center" href="#">
                                    <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path opacity="0.4"
                                ...
                                <a class="dropdown-item gap-2 d-flex align-items-center" href="#">
                                    <svg class="icon-20" xmlns="http://www.w3.org/2000/svg" width="20"
                                        ...
                                        <path d="M9.15961 13.1986L9.15957 13.1986L9.15961 13.1986Z" fill="currentColor"
                                            fill-opacity="0.4" stroke="currentColor" stroke-linecap="round"></path>
                                        <line x1="12.975" y1="12.6181" x2="11.2497" y2="18.6566" stroke="currentColor"
    ...
    <b-col lg="3">
      <div class="card-transparent mb-0 desk-info">
        <b-row>
          ...
          <draggable class="group1-wrap cust-kanban-drop" :list="openList" group="hui" itemKey="id">
    ...
    <b-col lg="3">
      <div class="card-transparent mb-0 desk-info">
        <b-row>
          ...
          <draggable class="group1-wrap cust-kanban-drop" :list="inProgressList" group="hui" itemKey="id">
            <template #item="{ element }">
              <div class="col-12 group">
                <div class="group__item">
                  <task-widget :title="element.title"></task-widget>
    ...
    <b-col lg="3">
      <div class="card-transparent mb-0 desk-info">
        <b-row>
          ...
          <draggable class="group1-wrap cust-kanban-drop" :list="reviewList" group="hui" itemKey="id">
            <template #item="{ element }">
              <div class="col-12 group">
                <div class="group__item">
                  <task-widget :title="element.title"></task-widget>
    ...
    <b-col lg="3">
      <div class="card-transparent mb-0 desk-info">
        <b-row>
          <b-col cols="12">
            <b-card class="kanban-drop-last-child">
          ...
          <draggable class="group1-wrap" :list="closedList" group="hui" itemKey="id">
            <template #item="{ element }">
              <div class="col-12 group">
                <div class="group__item kanban-drop-last-child">
                  <task-widget :title="element.title"></task-widget>
                </div>
              </div>
            </template>
