  ...
  <b-row>
    <b-col lg="6">
      <b-card no-body>
        ...
        <b-card-body>
          <HighchartsVue :options="BasicLineChart" />
        </b-card-body>
      </b-card>
    </b-col>
    <b-col lg="6">
      <b-card no-body>
        ...
        <b-card-body>
          <HighchartsVue :options="AreaChart" />
        </b-card-body>
      </b-card>
    </b-col>
    <b-col lg="6">
      <b-card no-body>
        <b-card-header class="mb-0">
          <div class="card-title">
            <h4>Column and Bar Chart</h4>
          </div>
        </b-card-header>
        <b-card-body>
          <HighchartsVue :options="ColumnAndBarChart" />
        </b-card-body>
      </b-card>
    </b-col>
    <b-col lg="6">
      <b-card no-body>
        ...
        <b-card-body>
          <HighchartsVue :options="ScatterplotChart" />
        </b-card-body>
      </b-card>
    </b-col>
    <b-col lg="6">
      <b-card no-body>
        ...
        <b-card-body>
          <HighchartsVue :options="PieChart" />
        </b-card-body>
      </b-card>
    </b-col>
    <b-col lg="6">
      <b-card no-body>
        <b-card-header class="mb-0">
          <div class="card-title">
            <h4>Dual axes, line and column Chart</h4>
          </div>
        </b-card-header>
        <b-card-body>
          <HighchartsVue :options="Dualaxes" />
        </b-card-body>
      </b-card>
    </b-col>
    <b-col lg="6">
      <b-card no-body>
        ...
        <b-card-body>
          <HighchartsVue :options="DynamicChart" />
        </b-card-body>
      </b-card>
    </b-col>
    <b-col lg="6">
      <b-card no-body>
        ...
        <b-card-body>
          <HighchartsVue :options="ThreeDChart" />
        </b-card-body>
      </b-card>
    </b-col>
    <b-col lg="6">
      <b-card no-body>
        ...
        <b-card-body>
          <HighchartsVue :options="GaugesChart" />
        </b-card-body>
      </b-card>
    </b-col>
    <b-col lg="6">
      <b-card no-body>
        <b-card-header class="mb-0">
          <div class="card-title">
            <h4>Bar With Nagative Chart</h4>
          </div>
        </b-card-header>
        <b-card-body>
          <HighchartsVue :options="BarWithNagativeChart" />
        </b-card-body>
      </b-card>
    </b-col>
  </b-row>
...
// Define categories for the age groups
const categories = ["0-4", "5-9", "10-14", "15-19", "20-24", "25-29", "30-34", "35-39", "40-44", "45-49", "50-54", "55-59", "60-64", "65-69", "70-74", "75-79", "80-84", "85-89", "90-94", "95-99", "100 + "];

const BarWithNagativeChart = ref({
  chart: {
    type: "bar"
  },
  title: {
