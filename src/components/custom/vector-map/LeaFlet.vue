...
export default {
  ...
  methods: {
    mapoption() {
      ...
      tileLayer.addTo(map)
      const cloudy = L.icon({
        iconUrl: generateImgPath('/assets/images/vectormap/cloudy.png'),
      ...
      const day = L.icon({
        iconUrl: generateImgPath('/assets/images/vectormap/day.png'),
        iconSize: [70, 70], // size of the icon
        iconAnchor: [22, 94], // point of the icon which will correspond to marker's location
        popupAnchor: [-3, -76] // point from which the popup should open relative to the iconAnchor
      })
      ...
      const rainy = L.icon({
        iconUrl: generateImgPath('/assets/images/vectormap/rainy-1.png'),
        iconSize: [70, 70], // size of the icon
        iconAnchor: [22, 94], // point of the icon which will correspond to marker's location
        popupAnchor: [-3, -76] // point from which the popup should open relative to the iconAnchor
      })
      ...
      const snowy = L.icon({
        iconUrl: generateImgPath('/assets/images/vectormap/snowy-6.png'),
        iconSize: [70, 70], // size of the icon
        iconAnchor: [22, 94], // point of the icon which will correspond to marker's location
        popupAnchor: [-3, -76] // point from which the popup should open relative to the iconAnchor
      })
      ...
      const cloudy22 = L.icon({
        iconUrl: generateImgPath('/assets/images/vectormap/cloudy-day-1.png'),
        iconSize: [70, 70], // size of the icon
        iconAnchor: [22, 94], // point of the icon which will correspond to marker's location
        popupAnchor: [-3, -76] // point from which the popup should open relative to the iconAnchor
      })
      ...
      const thunder = L.icon({
        iconUrl: generateImgPath('/assets/images/vectormap/thunder.png'),
        iconSize: [70, 70], // size of the icon
        iconAnchor: [22, 94], // point of the icon which will correspond to marker's location
        popupAnchor: [-3, -76] // point from which the popup should open relative to the iconAnchor
      })
