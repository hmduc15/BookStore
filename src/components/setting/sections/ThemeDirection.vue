<template>
  <div>
    ...
    <radio-input
      ...
      btn-name="theme_scheme_direction"
      :img-component="true"
      label-title="LTR"
      class-name="form-check mb-3 w-100"
      ...
      :default-checked="themeSchemeDirection"
      value="ltr"
      @on-change="store.theme_scheme_direction"
    >
      <span>LTR</span>
      <svg
        class="text-primary"
    ...
    >
      ...
      >
        <circle
          r="6.5"
          transform="matrix(-1 0 0 1 48.5 13.5002)"
          fill="currentColor"
        ></circle>
        <rect
          width="34"
          height="5"
          rx="2"
          transform="matrix(-1 0 0 1 39 7.70026)"
          fill="#80868B"
        ></rect>
        <rect
          opacity="0.5"
