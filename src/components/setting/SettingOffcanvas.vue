<template>
  ...
  <b-offcanvas
    ...
    class="live-customizer custom-customizer-header"
    :body-scrolling="true"
  >
    <template #title>
      <div class="d-flex align-items-center">
        <h4 class="offcanvas-title pe-2" id="live-customizer-label">
          Setting Panel
        </h4>
        <div class="d-flex gap-2 align-items-center pe-2">
          <button
            tag="button"
            class="btn btn-primary p-2 d-flex align-items-center gap-1"
            data-copy="settings"
